...
PiNCNode piNCNode;
ZetaINode zetaINode;
ZetaClNode zetaClNode;
ZetaENode zetaENode;
NuRNode nuRNode;
ZetaQNode zetaQNode;
ZetaLNode zetaLNode;
AlphaCNode alphaCNode;
SigmaCNode sigmaCNode;
AlphaCNNode alphaCNNode;
SigmaCNNode sigmaCNNode;
AlphaChNode alphaChNode;
SigmaChNode sigmaChNode;
AlphaANode alphaANode;
SigmaANode sigmaANode;
AlphaNCNode alphaNCNode;
SigmaNCNode sigmaNCNode;
AlphaINode alphaINode;
SigmaINode sigmaINode;
AlphaClNode alphaClNode;
SigmaClNode sigmaClNode;
AlphaENode alphaENode;
SigmaENode sigmaENode;
AlphaRNode alphaRNode;
SigmaRNode sigmaRNode;
AlphaQNode alphaQNode;
SigmaQNode sigmaQNode;
AlphaLNode alphaLNode;
SigmaLNode sigmaLNode;
UCNode uCNode;
UCNNode uCNNode;
UChNode uChNode;
UANode uANode;
